          ...
          if( e.code !== '0000' ){
            ...
            return;
  		    ...
  		    content = _data.content;
					content.target = _data.target;
					content.trigger = true;

          this.tabIndex = opt.tabIndex;

          if( _list && _list[this.tabIndex] && _list[this.tabIndex]["name"] == opt.tabIndex ){
      ...
      return (
        <div {...touchEvents}>
          <div className="list-wrapper" ref="listW" >
            <Tab data={_data.tabData} current="current" className="list-header" ref="topTab" refName="topTab" tabHandleFn={this.tabHandleFn}  />
            <ListContent className="list-content" data={this.state.tabContent}  ref="listContent"  refName="listContent" contentHandleFn={this.listContentFn} totalFn={this.totalFn} />
          </div>
          <MiniCart handleFn={this.balanceFn} data={MiniCartData} className="goToBalance" />
